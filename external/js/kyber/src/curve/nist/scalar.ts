...
export default class NistScalar implements Scalar {
    ref: { arr: BN, red: Red, curve: Weierstrass}
    constructor(curve: Weierstrass, red: Red) {
        this.ref = {
    ...
    */
    setBytes(b: Uint8Array): NistScalar{
    ...
    */
    pick(callback?: (length: number) => Uint8Array): NistScalar {
